...
angle = int(input("please enter initial Angle "))
obs = int(input ("please enter the number of obstacles "))
targ_x = int(input("please enter x coordinate of the target ")) 
targ_y = int(input("please enter y coordinate of the target "))
RobotShape = VehicleIcon ("robot.png", scale = 3)
Robot = Bicycle(
